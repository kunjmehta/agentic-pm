...
class TestGetPortfolioStatus:
    ...
    @patch('src.agentic.agents.portfolio_tools.fetch_account_info')
    @patch('src.agentic.agents.portfolio_tools.fetch_positions')
    @patch('src.agentic.agents.portfolio_tools.PortfolioDAO')
