...
class TestDefaultHandlers:
    ...
    async def test_default_trade_handler(self):
        ...
        from src.common.data_gatherer.alpaca_stream import default_trade_handler
    ...
    async def test_default_bar_handler(self):
        ...
        from src.common.data_gatherer.alpaca_stream import default_bar_handler
    ...
    async def test_default_status_handler(self):
        ...
        from src.common.data_gatherer.alpaca_stream import default_status_handler
