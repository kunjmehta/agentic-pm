...
class TestSignalHandlerSetup:
    ...
    @patch('src.common.data_gatherer.alpaca_stream.StockDataStream')
    def test_signal_handler_setup_in_main_thread(self, mock_stream):
        ...
        with patch('src.common.data_gatherer.alpaca_stream.signal.signal') as mock_signal:
    ...
    def test_signal_handler_skipped_in_background_thread(self, mock_stream):
        ...
        with patch('src.common.data_gatherer.alpaca_stream.threading.current_thread', return_value=mock_thread):
            with patch('src.common.data_gatherer.alpaca_stream.threading.main_thread', return_value=mock_main_thread):
                with patch('src.common.data_gatherer.alpaca_stream.signal.signal') as mock_signal:
                    streamer._setup_signal_handlers()
