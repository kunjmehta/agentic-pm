...
class TestMACDOutput:
    def test_all_none_defaults(self):
        from src.server.models.strategies import MACDOutput
        m = MACDOutput()
...
class TestMomentumOutput:
    def test_defaults_from_empty_dict(self):
        from src.server.models.strategies import MomentumOutput
    ...
    def test_full_round_trip(self):
        from src.server.models.strategies import MomentumOutput, MACDOutput
        raw = {
            "symbol": "AAPL",
...
class TestVolatilityOutput:
    def test_defaults_from_empty_dict(self):
        from src.server.models.strategies import VolatilityOutput
...
class TestVolumeOutput:
    def test_defaults_from_empty_dict(self):
        from src.server.models.strategies import VolumeOutput
...
class TestCandleOutput:
    def test_defaults_from_empty_dict(self):
        from src.server.models.strategies import CandleOutput
...
class TestBacktestMetrics:
    def test_all_fields_optional(self):
        from src.server.models.strategies import BacktestMetrics
        m = BacktestMetrics()
...
class TestBacktestOutput:
    def test_required_fields(self):
        from src.server.models.strategies import BacktestOutput
        b = BacktestOutput(
    ...
    def test_with_nested_metrics(self):
        from src.server.models.strategies import BacktestOutput, BacktestMetrics
        b = BacktestOutput(
            strategy="momentum",
            ticker="TSLA",
            start_date="2025-01-01",
...
class TestMeanReversionOutput:
    def test_defaults_from_empty_dict(self):
        from src.server.models.strategies import MeanReversionOutput
...
class TestPortfolioStatusOutput:
    def test_defaults_from_empty_dict(self):
        from src.server.models.strategies import PortfolioStatusOutput
...
class TestPositionsSummaryOutput:
    def test_defaults_from_empty_dict(self):
        from src.server.models.strategies import PositionsSummaryOutput
...
class TestHealthModels:
    def test_health_violation_defaults(self):
        from src.server.models.strategies import HealthViolation
        hv = HealthViolation()
        assert hv.rule == ""
    ...
    def test_health_risk_params_defaults(self):
        from src.server.models.strategies import HealthRiskParams
        rp = HealthRiskParams()
    ...
    def test_health_check_output_defaults_from_empty(self):
        from src.server.models.strategies import HealthCheckOutput
    ...
    def test_health_check_output_with_violations(self):
        from src.server.models.strategies import HealthCheckOutput, HealthViolation
        h = HealthCheckOutput(
...
class TestFetchHistoricalDataOutput:
    def test_defaults_from_empty_dict(self):
        from src.server.models.strategies import FetchHistoricalDataOutput
...
class TestDataAvailabilityOutput:
    def test_defaults_from_empty_dict(self):
        from src.server.models.strategies import DataAvailabilityOutput
...
class TestSnapshotSaveOutput:
    def test_defaults_from_empty_dict(self):
        from src.server.models.strategies import SnapshotSaveOutput
...
class TestSimulationOutputFamily:
    def test_simulation_output_defaults(self):
        from src.server.models.strategies import SimulationOutput
    ...
    def test_snapshot_worth_output_inherits_simulation(self):
        from src.server.models.strategies import SnapshotWorthOutput
    ...
    def test_swap_positions_output_extra_fields(self):
        from src.server.models.strategies import SwapPositionsOutput
...
class TestOutHelper:
    ...
    def test_valid_dict_returns_model_dump(self):
        from src.server.registry.functions import _out
        from src.server.models.strategies import MomentumOutput
...
class TestGetPortfolioStatusWrapper:
    ...
    def test_calls_underlying_and_returns_validated_dict(self):
        from src.server.registry.functions import _get_portfolio_status_wrapped
...
class TestGetPositionsSummaryWrapper:
    ...
    def test_calls_underlying_and_returns_validated_dict(self):
        from src.server.registry.functions import _get_positions_summary_wrapped
...
class TestCheckPortfolioHealthWrapper:
    ...
    def test_auto_fetches_when_not_provided(self):
        from src.server.registry.functions import _check_portfolio_health_wrapped
...
class TestSnapshotWorthWrapper:
    ...
    def test_missing_snapshot_date_returns_error(self):
        from src.server.registry.functions import _snapshot_worth_wrapped
...
class TestSwapPositionsWrapper:
    ...
    def test_missing_dates_returns_error(self):
        from src.server.registry.functions import _swap_positions_wrapped
...
class TestSaveEODSnapshotWrapper:
    ...
    def test_calls_raw_with_filled_defaults(self):
        from src.server.registry.functions import _save_eod_snapshot_wrapped
