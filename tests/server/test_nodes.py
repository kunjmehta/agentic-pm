...
class TestFunctionCallModels:
    ...
    def test_function_call_defaults(self):
        from src.server.models.task import FunctionCall
    ...
    def test_agent_plan_with_calls(self):
        from src.server.models.task import AgentPlan, FunctionCall
        plan = AgentPlan(
            calls=[
    ...
    def test_function_call_edit_remove(self):
        from src.server.models.task import FunctionCallEdit
    ...
    def test_pm_feedback_approved_no_edits(self):
        from src.server.models.task import PMFeedback
    ...
    def test_pm_feedback_approved_with_quant_edits(self):
        from src.server.models.task import PMFeedback, FunctionCallEdit
        fb = PMFeedback(
            approved=True,
...
class TestResponseModels:
    ...
    def test_execution_result_error_status(self):
        from src.server.models.responses import ExecutionResult
        er = ExecutionResult(
            task_id="pm_001",
    ...
    def test_approval_request_all_optional(self):
        from src.server.models.responses import ApprovalRequest
        req = ApprovalRequest()
    ...
    def test_query_request_defaults(self):
        from src.server.models.responses import SemiAutoQueryRequest
    ...
    def test_semi_auto_response_success_defaults(self):
        from src.server.models.responses import SemiAutoResponse
    ...
    def test_task_preview_quant_and_bt_tasks(self):
        from src.server.models.responses import TaskPreviewResponse
...
class TestGraphRouting:
    ...
    def test_route_market_guard_blocked(self):
        from src.server.graph import route_after_market_guard
    ...
    def test_route_pm_reasoning_error(self):
        from src.server.graph import route_after_pm_reasoning
    ...
    def test_route_after_quant_error(self):
        from src.server.graph import route_after_quant
    ...
    def test_route_after_backtester_error(self):
        from src.server.graph import route_after_backtester
    ...
    def test_route_after_pm_review_approved(self):
        from src.server.graph import route_after_pm_review
...
class TestSynthesizerHelpers:
    ...
    def test_format_execution_results_empty(self):
        from src.server.nodes.synthesizer import _format_execution_results
    ...
    def test_build_synthesis_prompt_includes_query(self):
        from src.server.nodes.synthesizer import _build_synthesis_prompt
        state = {
...
class TestPMReviewHelpers:
    ...
    def test_format_calls_empty(self):
        from src.server.nodes.pm_review_node import _format_calls
    ...
    def test_apply_edits_empty_edits(self):
        from src.server.nodes.pm_review_node import _apply_edits
...
class TestExecutorAdditional:
    ...
    def test_upstream_error_skips_execution(self):
        from src.server.nodes.executor_node import executor_node
    ...
    def test_to_native_numpy_array(self):
        from src.server.nodes.executor_node import _to_native
        try:
            import numpy as np
            arr = np.array([1, 2, 3])
    ...
    def test_extract_dep_params_wrong_status(self):
        ...
        from src.server.nodes.executor_node import _extract_dep_params
...
class TestClassifierHelpers:
    ...
    def _fb(self, query: str):
        ...
        from src.server.nodes.classifier import _keyword_fallback
...
class TestRegistrySchema:
    ...
    def test_all_registry_keys_have_descriptions(self):
        from src.server.registry.functions import get_registry_schema, FUNCTION_REGISTRY
