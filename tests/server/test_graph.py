...
class TestTaskModels:
    ...
    def test_task_item_defaults(self):
        from src.server.models.task import TaskItem
        item = TaskItem(
            task_id="pm_001",
    ...
    def test_task_list_serialization(self):
        from src.server.models.task import TaskItem, TaskList
        items = [
    ...
    def test_semi_auto_response(self):
        from src.server.models.responses import SemiAutoResponse, ExecutionResult
...
class TestRegistry:
    ...
    def test_registry_has_56_functions(self):
