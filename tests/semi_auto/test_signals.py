...
def _schema_already_done():
    ...
    """
    import src.semi_auto.routers.signals as _mod
...
class TestSignalModels:
    ...
    def test_signal_review_response_has_timestamp(self):
        from src.semi_auto.models.endpoints import SignalReviewResponse
    ...
    def test_hitl_enabled_flag(self):
        ...
        from src.semi_auto.routers.signals import _hitl_enabled
