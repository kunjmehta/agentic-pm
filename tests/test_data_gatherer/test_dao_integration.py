...
class TestAlpacaSkillsIntegration:
    ...
    def test_fetch_historical_bars_saves_to_db(self, mock_client, alpaca_dao):
        ...
        with patch('src.skills.alpaca_skills.AlpacaDAO', return_value=alpaca_dao):
            # Fetch bars
...
class TestAlphaVantageSkillsIntegration:
    ...
    def test_fetch_company_overview_saves_to_db(self, mock_request, av_dao):
        ...
        from src.skills.alpha_vantage_skills import fetch_company_overview
        ...
        with patch('src.skills.alpha_vantage_skills.AlphaVantageDAO', return_value=av_dao):
            # Fetch overview
    ...
    def test_fetch_dividends_saves_to_db(self, mock_request, av_dao):
        ...
        from src.skills.alpha_vantage_skills import fetch_dividend_history
...
class TestStreamHandlersIntegration:
    ...
    async def test_stream_handler_saves_to_db(self, alpaca_dao):
        ...
        from src.data_gatherer.db_stream_handlers import save_trade_to_db, save_bar_to_db
