...
class TestGetPortfolioStatus:
    ...
    @patch('src.agentic.agents.portfolio.skills.portfoliostatus.status.fetch_account_info')
    @patch('src.agentic.agents.portfolio.skills.portfoliostatus.status.fetch_positions')
    @patch('src.agentic.agents.portfolio.skills.portfoliostatus.status.PortfolioDAO')
...
class TestCheckPortfolioHealth:
    ...
    @patch('src.agentic.agents.portfolio_tools.get_portfolio_status')
    @patch('src.agentic.agents.portfolio_tools.get_positions_summary')
    @patch('src.agentic.agents.portfolio.skills.health.health.PortfolioDAO')
...
class TestDelegateToQuantAnalyst:
    ...
    @patch('src.agentic.agents.quant.analyst.QuantAnalyst')
