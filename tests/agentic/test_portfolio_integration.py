...
from src.agentic.agents.portfolio import PortfolioManager
...
class TestPortfolioManagerIntegration:
    ...
    def manager(self):
        ...
        return PortfolioManager(model="gpt-5-mini", backtest_mode=True)
    ...
    def test_risk_violation_handling(self, mock_dao_class, mock_datetime, manager):
        ...
        prod_manager = PortfolioManager(model="gpt-5-mini", backtest_mode=False)
...
class TestEndToEndWorkflows:
    ...
    def test_complete_portfolio_analysis_workflow(self):
        ...
        manager = PortfolioManager(model="gpt-5-mini", backtest_mode=True)
